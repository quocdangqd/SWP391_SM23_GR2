                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="general" data-filter="target">
                            ...
                            <tr>
                                ...
                                <td>Yes</td>
                                <td>${product2!=null?"Yes":""}</td>
                            </tr>
                            <tr>
                                <th>Operating system</th>
                                <td>iOS v12</td>
                                <!--<td>Android v9.0 Pie </td>-->
                                <td>${product2!=null?"Android v9.0 Pie":""}</td>
                            </tr>
                            <tr>
                                <th>Sim slots</th>
                                <td>Single SIM, GSM</td>
                                <!--<td>Single SIM, GSM</td>-->
                                <td>${product2!=null?"Single SIM, GSM":""}</td>
                            </tr>
                            <tr>
                                <th>Launch date</th>
                                <td>September 12, 2018 (Official)</td>
                                <!--<td>November 1, 2018 (Official)</td>-->
                                <td>${product2!=null?"November 1, 2018 (Official)":""}</td>
                            </tr>
                            <tr>
                                <th>Sim size</th>
                                <td>SIM1: Nano</td>
                                <!--                                <td>SIM1: Nano</td>-->
                                <td>${product2!=null?"SIM1: Nano":""}</td>
                            </tr>
                            <tr>
                                <th>Network</th>
                                <td>4G: Available (supports Indian bands) 3G: Available, 2G: Available</td>
                                <!--<td>4G: Available (supports Indian bands) 3G: Available, 2G: Available</td>-->
                                <td>${product2!=null?"4G: Available (supports Indian bands) 3G: Available, 2G: Available":""}</td>
                            </tr>
                            <tr>
                                <th>Fingerprint sensor</th>
                                <td>None (Face ID)</td>
                                <!--                                <td>Back cover</td>-->
                                <td>${product2!=null?"Back cover":""}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody id="performance" data-filter="target">
                            ...
                            <tr>
                                ...
                                <td>${product2!=null?"Qualcomm Snapdragon 845 (2.5GHz octa-core)":""}</td>
                            </tr>
                            <tr>
                                <th>Graphics</th>
                                <td>Apple GPU (4-core graphics)</td>
                                <!--<td>Adreno 630</td>-->
                                <td>${product2!=null?"Adreno 630":""}</td>
                            </tr>
                            <tr>
                                <th>Architecture</th>
                                <td>64 bit</td>
                                <td>${product2!=null?"64 bit":""}</td>
                            </tr>
                            <tr>
                                <th>RAM</th>
                                <td>4 GB</td>
                                <!--<td>4 GB</td>-->
                                <td>${product2!=null?"4 GB":""}</td>
                            </tr>
                        </tbody>
                        <tbody id="design" data-filter="target">
                            ...
                            <tr>
                                ...
                                <td>${product2!=null?"Case: AluminiumBack: Aluminium":""}</td>
                            </tr>
                            <tr>
                                <th>Thickness</th>
                                <td>7.7 mm</td>
                                <!--<td>7.9 mm</td>-->
                                <td>${product2!=null?"7.9 mm":""}</td>
                            </tr>
                            <tr>
                                <th>Width</th>
                                <td>70.9 mm</td>
                                <td>${product2!=null?"70.9 mm":""}</td>
                            </tr>
                            <tr>
                                <th>Height</th>
                                <td>143.6 mm</td>
                                <!--<td>157.9 mm</td>-->
                                <td>${product2!=null?"157.9 mm":""}</td>
                            ...
                            <tr>
                                ...
                                <td>174 grams</td>
                                <!--<td>175 grams</td>-->
                                <td>${product2!=null?"175 grams":""}</td>
                            </tr>
                            <tr>
                                <th>Waterproof</th>
                                <td>Yes Water resistant (up to 30 minutes in a depth of 1 meter), IP67</td>
                                <!--<td>Yes Water resistant (up to 30 minutes in a depth of 1 meter), IP67</td>-->
                                <td>${product2!=null?"Yes Water resistant (up to 30 minutes in a depth of 1 meter), IP67":""}</td>
                            </tr>
                            <tr>
                                <th>Colors</th>
                                <td>Silver, Space Grey</td>
                                <!--<td>Black, Black and White</td>-->
                                <td>${product2!=null?"Black, Black and White":""}</td>
                            </tr>
                        </tbody>
                        <tbody id="display" data-filter="target">
                            ...
                            <tr>
                                ...
                                <!--<td>'flexible' OLED</td>-->
                                <td>${product2!=null?"'flexible' OLED":""}</td>
                            </tr>
                            <tr>
                                <th>Pixel density</th>
                                <td>458 ppi</td>
                                <!--                                <td>522 ppi</td>-->
                                <td>${product2!=null?"522 ppi":""}</td>
                            </tr>
                            <tr>
                                <th>Screen protection</th>
                                <td>Yes</td>
                                <!--<td>Corning Gorilla Glass v5</td>-->
                                <td>${product2!=null?"Corning Gorilla Glass v5":""}</td>
                            </tr>
                            <tr>
                                <th>Screen size</th>
                                <td>6.5 inches</td>
                                <!--<td>6.3 inches</td>-->
                                <td>${product2!=null?"6.3 inches":""}</td>
                            </tr>
                            <tr>
                                <th>Screen resolution</th>
                                <td>1125 x 2436 pixels</td>
                                <!--<td>1440 x 2880 pixels</td>-->
                                <td>${product2!=null?"1440 x 2880 pixels":""}</td>
                            </tr>
                            <tr>
                                <th>Touch screen</th>
                                <td>Yes, 3D Touch Touchscreen, Multi-touch</td>
                                <!--<td>Yes, Capacitive Touchscreen, Multi-touch</td>-->
                                <td>${product2!=null?"Yes, Capacitive Touchscreen, Multi-touch":""}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody id="camera" data-filter="target">
                            ...
                            <tr>
                                ...
                                <!--                                <td>Exposure compensation, ISO control</td>-->
                                <td>${product2!=null?"Exposure compensation, ISO control":""}</td>
                            </tr>
                            <tr>
                                <th>Aperture</th>
                                <td>F2.2</td>
<!--                                <td>F2.4</td>-->
                                <td>${product2!=null?"F2.4":""}</td>
                            </tr>
                            <tr>
                                <th>Camera features</th>
                                <td>10 x Digital zoom, Optical zoom, Auto flash, Face detection, Touch to focus</td>
<!--                                <td>Fixed zocus</td>-->
                                <td>${product2!=null?"Fixed zocus":""}</td>
                            </tr>
                            <tr>
                                <th>Image resolution</th>
                                <td>4000 x 3000 pixels</td>
<!--                                <td>4000 x 3000 pixels</td>-->
                                <td>${product2!=null?"4000 x 3000 pixels":""}</td>
                            </tr>
                            <tr>
                                <th>Sensor</th>
                                <td>BSI sensor</td>
<!--                                <td>CMOS image sensor</td>-->
                                <td>${product2!=null?"CMOS image sensor":""}</td>
                            </tr>
                            <tr>
                                <th>Autofocus</th>
                                <td>Yes</td>
...
<!--                                <td>Continuos shooting, High dynamic range mode (HDR)</td>-->
                                <td>${product2!=null?"Continuos shooting, High dynamic range mode (HDR)":""}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>${product2!=null?"Yes, Dual LED flash":""}</td>
                            </tr>
                        </tbody>
                        <tbody id="battery" data-filter="target">
                            ...
                            <tr>
                                ...
                                <td>${product2!=null?"Up to 24 hours(4G)":""}</td>
                            </tr>
                            <tr>
                                <th>Quick charging</th>
                            ...
                            <tr>
                                ...
                                <td>Li-ion</td>
                                <!--<td>Li-ion</td>-->
                                <td>${product2!=null?"Li-ion":""}</td>
                            </tr>
                            <tr>
                                <th>Capacity</th>
                                <td>3,174 mAh</td>
                                <!--<td>3,430 mAh</td>-->
                                <td>${product2!=null?"3,430 mAh":""}</td>
                            </tr>
                        </tbody>
