<%-- 
    Document   : accountbanned
    Created on : 24-05-2023, 01:37:09
    Author     : trand
--%>
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item active" href="accountmanager.jsp"><i class='app-menu__icon bx bx-run'></i><span
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Tạo mới danh sách tài khoản</h3>
                        <div class="tile-body">
                        ...
                        <a class="btn btn-cancel" href="accountmanager.jsp">Hủy bỏ</a>
                    </div>
                    </main>
