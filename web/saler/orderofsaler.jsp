...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <hr>
            <ul class="app-menu">
                <li><a class="app-menu__item active" href="orderofsaler.jsp"><i class='app-menu__icon bx bx-tachometer'></i><span
                            class="app-menu__label">Thông tin đơn hàng</span></a></li>
                <li><a class="app-menu__item " href="customerofsaler.jsp"><i class='app-menu__icon bx bx-id-card'></i> <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="tile">
                                ...
                                <h4 class="tile-title">Saler: ${sessionScope.user.user_name} </h4>
                                <div>
